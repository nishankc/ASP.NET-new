...
(function() {
    ...
    function w(a, c, b) {
        ...
        Ka(this.ctx),
        u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = $(a, c),
        ...
        this._toolTip = new V(this,this._options.toolTip,this.theme),
    ...
    function F(a, c, b, d) {
        F.base.constructor.call(this, "Axis", c, a.theme);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = a.ctx;
    ...
    function V(a, c, b) {
        V.base.constructor.call(this, "ToolTip", c, b);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
            ...
            "#" === c || "0" === c)
                ...
                p === m) {
                    var t = g
                      , g = [];
                    if ("0" === c)
                        for (c = m - l - (t ? t.length : 0); 0 < c; )
                            t.unshift("0"),
                            c--;
                    for (; 0 < t.length; )
                        b = t.pop() + b,
                        y++,
                        0 === y % r && (h === q && 0 < t.length) && (b = f + b);
                    d && (b = "-" + b)
                } else
    ...
    w.prototype._updateOptions = function() {
        ...
        this._options.zoomEnabled ? (this._zoomButton || (X(this._zoomButton = document.createElement("button")),
        U(this, this._zoomButton, "pan"),
        this._toolBar.appendChild(this._zoomButton),
        J(this._zoomButton, "click", function() {
            a.zoomEnabled ? (a.zoomEnabled = !1,
            a.panEnabled = !0,
            U(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0,
            a.panEnabled = !1,
            U(a, a._zoomButton, "pan"));
            a.render()
        })),
        this._resetButton || (X(this._resetButton = document.createElement("button")),
        U(this, this._resetButton, "reset"),
        ...
        this._menuButton ? this.exportEnabled ? la(this._menuButton) : X(this._menuButton) : this.exportEnabled && u && (this._menuButton = document.createElement("button"),
        U(this, this._menuButton, "menu"),
        this._toolBar.appendChild(this._menuButton),
        J(this._menuButton, "click", function() {
        ...
        "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? U(a, a._zoomButton, "zoom") : U(a, a._zoomButton, "pan"),
        a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && U(a, a._resetButton, "reset"));
    ...
    w.prototype.render = function(a) {
        ...
        for (a = 0; a < this.data.length; a++)
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
                ...
                this.data[a].axisY = this.axisY2) : (this.axisY || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY = new F(this,this._options.axisY,"axisY","left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY = new F(this,this._options.axisY,"axisY","bottom"))),
                this.data[a].axisY = this.axisY),
                this.axisX || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX = new F(this,this._options.axisX,"axisX","bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX = new F(this,this._options.axisX,"axisX","left"))),
        ...
        b ? la(this._zoomButton, this._resetButton) : (X(this._zoomButton, this._resetButton),
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            ...
            b = 0; b < c.plotUnits.length; b++) {
                var f = c.plotUnits[b]
                  , g = null ;
                f.targetCanvas = null ;
                this.animatedRender && (f.targetCanvas = $(this.width, this.height),
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = $(this.width, this.height).getContext("2d"),
    ...
    w.prototype.categoriseDataSeries = function() {
        for (var a = "", c = 0; c < this.data.length; c++)
            if (a = this.data[c],
            a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= w._supportedChartTypes.indexOf(a.type)) {
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
                    var l = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity
            ...
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = [], h = [], p = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                for (m = 0; m < n.dataPoints.length; m++) {
                    ...
                    if (0 < m) {
                        ...
                        null !== e && null !== n.dataPoints[m - 1].y && (t = e - n.dataPoints[m - 1].y,
                        0 > t && (t *= -1),
    ...
    w.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = !1, h = !1, p = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                for (m = 0; m < n.dataPoints.length; m++) {
                    ...
                    if (0 < m) {
                        ...
                        0 > t && (t *= -1);
                        b.minDiff > t && 0 !== t && (b.minDiff = t);
                        x(e) || null === n.dataPoints[m - 1].y || (t = e - n.dataPoints[m - 1].y,
                        0 > t && (t *= -1),
                        c.minDiff > t && 0 !== t && (c.minDiff = t))
                    }
                    if (d < s && !l)
            ...
            g && !h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99),
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, h = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                for (n = 0; n < k.dataPoints.length; n++) {
                    ...
                    f < c.min && (c.min = f);
                    g > c.max && (c.max = g);
                    0 < n && (r = d - k.dataPoints[n - 1].x,
                    0 > r && (r *= -1),
                    b.minDiff > r && 0 !== r && (b.minDiff = r),
                    e && (null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0]) && (r = e[0] - k.dataPoints[n - 1].y[0],
                    0 > r && (r *= -1),
                    c.minDiff > r && 0 !== r && (c.minDiff = r)));
                    if (!(d < y) || m) {
                        if (!m && (m = !0,
    ...
    w.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (e = R("markerSize", d[b].dataPoint, d[b].dataSeries) || 8,
                d[b].distance <= e / 2) {
                    c = !0;
                    break
                }
    ...
    w.prototype._mouseEventHandler = function(a) {
        ...
        w.capturedEventParam && (d = w.capturedEventParam,
        "mouseup" === b && (w.capturedEventParam = null ,
                    ...
                    for (var f = 0; f < this._events.length; f++)
                        if (this._events[f].hasOwnProperty(b))
                            ...
                            c.x >= e.x1 && c.x <= e.x2 && c.y >= e.y1 && c.y <= e.y2) {
                                ...
                                "mousedown" === b && !0 === d.capture ? (w.capturedEventParam = d,
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)
                    for (e = f = 0; e < this._axes.length; e++)
                        b = this._axes[e],
                        b.viewportMinimum < b.minimum ? (f = b.minimum - b.viewportMinimum,
    ...
    w.prototype.renderIndexLabels = function(a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, h = 0, p = 0; p < this._indexLabels.length; p++) {
            var k = this._indexLabels[p], n = k.chartType.toLowerCase(), m, l, q = R("indexLabelFontColor", k.dataPoint, k.dataSeries), g = R("indexLabelFontSize", k.dataPoint, k.dataSeries), h = R("indexLabelFontFamily", k.dataPoint, k.dataSeries);
            ...
            if (0 <= k.dataSeries.type.indexOf("stacked") || "pie" === k.dataSeries.type || "doughnut" === k.dataSeries.type)
                t = this.getPercentAndTotal(k.dataSeries, k.dataPoint);
            ...
            if (null !== v && "" !== v) {
                ...
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                    ...
                    if (k.dataPoint.x < W.viewportMinimum || k.dataPoint.x > W.viewportMaximum || k.bounds.y1 > c.y2 || k.bounds.y2 < c.y1)
                        continue
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    "inside" !== t ? (d = c.y1,
                    e = c.y2,
                    0 < u ? (l = k.point.y - h - f - b,
                    l < d && (l = "auto" === t ? Math.max(k.point.y, d) + f + b : d + f + b,
                    w = l + h > k.point.y)) : (l = k.point.y + f + b,
                    l > e - h - f - b && (l = "auto" === t ? Math.min(k.point.y, e) - h - f - b : e - h - f - b,
                    w = l < k.point.y))) : (d = Math.max(k.bounds.y1, c.y1),
                    e = Math.min(k.bounds.y2, c.y2),
                    b = 0 <= n.indexOf("range") ? 0 < u ? Math.max(k.bounds.y1, c.y1) + h / 2 + f : Math.min(k.bounds.y2, c.y2) - h / 2 - f : (Math.max(k.bounds.y1, c.y1) + Math.min(k.bounds.y2, c.y2)) / 2,
                    0 < u ? (l = Math.max(k.point.y, b) - h / 2,
                    ...
                    d = 4) : 0 <= n.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === n && (t = "inside"),
                    l = k.point.y - h / 2,
                    "inside" !== t ? (f = c.x1,
                    e = c.x2,
                    0 > u ? (m = k.point.x - g - d - b,
                    m < f && (m = "auto" === t ? Math.max(k.point.x, f) + d + b : f + d + b,
                    w = m + g > k.point.x)) : (m = k.point.x + d + b,
                    m > e - g - d - b && (m = "auto" === t ? Math.min(k.point.x, e) - g - d - b : e - g - d - b,
                    w = m < k.point.x))) : (f = Math.max(k.bounds.x1, c.x1),
                    Math.min(k.bounds.x2, c.x2),
                    b = 0 <= n.indexOf("range") ? 0 > u ? Math.max(k.bounds.x1, c.x1) + g / 2 + d : Math.min(k.bounds.x2, c.x2) - g / 2 - d : (Math.max(k.bounds.x1, c.x1) + Math.min(k.bounds.x2, c.x2)) / 2,
                    m = 0 > u ? Math.max(k.point.x, b) - g / 2 : Math.min(k.point.x, b) - g / 2,
                    m = Math.max(m, f));
                "vertical" === z && (l += h);
                q.x = m;
                q.y = l;
                q.render(!0);
                y && ("inside" !== t && (0 > n.indexOf("bar") && k.point.x > c.x1 && k.point.x < c.x2 || !w) && (0 > n.indexOf("column") && k.point.y > c.y1 && k.point.y < c.y2 || !w)) && (a.lineWidth = y,
                a.strokeStyle = s ? s : "gray",
                a.setLineDash && a.setLineDash(D(r, y)),
                a.beginPath(),
                a.moveTo(k.point.x, k.point.y),
                0 <= n.indexOf("bar") ? a.lineTo(m + (0 < k.direction ? 0 : g), l + ("horizontal" === z ? h : -h) / 2) : 0 <= n.indexOf("column") ? a.lineTo(m + g / 2, l + ((0 < k.direction ? h : -h) + ("horizontal" === z ? h : -h)) / 2) : a.lineTo(m + g / 2, l + ((l < k.point.y ? h : -h) + ("horizontal" === z ? h : -h)) / 2),
                a.stroke())
            }
        }
        return {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < h.length) {
                    for (var t = !1, r = 0; r < h.length; r++)
                        ...
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !t)))
                            if ("number" !== typeof h[r].y)
                                0 < r && !(g.connectNullData || t || q) && (c.stroke(),
                                u && b.stroke()),
                                t = !0;
                            else {
                                ...
                                q || t ? (!q && g.connectNullData ? (c.setLineDash && (g._options.nullDataLineDashType || p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(),
                                p = g.nullDataLineDashType,
                                c.setLineDash(k)),
                                c.lineTo(s, y),
                                u && b.lineTo(s, y)) : (c.beginPath(),
                                c.moveTo(s, y),
                                u && (b.beginPath(),
                                b.moveTo(s, y))),
                                t = q = !1) : (c.lineTo(s, y),
                    ...
                    for (var t = !1, r = 0; r < h.length; r++)
                        ...
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !t)))
                            if ("number" !== typeof h[r].y)
                                ...
                                c.setLineDash(n))));
                                if (0 < h[r].markerSize || 0 < g.markerSize)
                                    z = g.getMarkerProperties(r, s, y, c),
                                    d.push(z),
                                    v = C(v),
                                    u && d.push({
                                        x: s,
        ...
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c = 0; c < a.length - 3; c += 3)
                    ...
                    u && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                    ...
                    r = 0; r < p.length; r++)
                        ...
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !y)))
                            if ("number" !== typeof p[r].y)
                                0 < r && !y && (h.connectNullData ? b.setLineDash && (0 < t.length && (h._options.nullDataLineDashType || !p[r - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = n,
                                k = h.nullDataLineDashType) : (c(t),
                                t = [])),
                                y = !0;
                            else {
                                s = a.axisX.convertValueToPixel(s);
                                ...
                                t[t.length - 1].newStrokeStyle = q,
                                b.setLineDash && (p[r].lineDashType ? (k = p[r].lineDashType,
                                t[t.length - 1].newLineDashArray = D(k, h.lineThickness)) : (k = h.lineDashType,
    ...
    w.prototype.renderStackedColumn = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null , d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.convertValueToPixel(0), g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (b = q[g].x.getTime ? q[g].x.getTime() : q[g].x,
                        !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
    ...
    w.prototype.renderBar = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null , d = this.plotArea, e = 0, f, g, h, p = a.axisY.convertValueToPixel(0), e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
    ...
    w.prototype.renderStackedBar = function(a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null , d = this.plotArea, e = [], f = [], g = 0, h, p = a.axisY.convertValueToPixel(0), g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
    ...
    w.prototype.renderArea = function(a) {
        function c() {
            z && (0 < k.lineThickness && b.stroke(),
            0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? t = y : 0 > a.axisY.viewportMaximum ? t = f.y1 : 0 < a.axisY.viewportMinimum && (t = e.y2),
            b.lineTo(q, t),
            b.lineTo(z.x, t),
            b.closePath(),
                    ...
                    for (var I = !0; l < n.length; l++)
                        ...
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !I)))
                            if ("number" !== typeof n[l].y)
                                ...
                                u && d.lineTo(q, r),
                                0 == l % 250 && c());
                                l < n.length - 1 && (w !== (n[l].lineColor || x) || A !== (n[l].lineDashType || k.lineDashType)) && (c(),
                                w = n[l].lineColor || x,
                                b.strokeStyle = w,
            ...
            if (0 < c.length) {
                if (0 < k.lineThickness) {
                    ...
                    for (var g = 0; g < c.length - 3; g += 3)
                        ...
                        u && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y),
                    ...
                    for (q = !1; m < n.length; m++)
                        ...
                        !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !q)))
                            if ("number" !== typeof n[m].y)
                                0 < m && !q && (k.connectNullData ? b.setLineDash && (0 < t.length && (k._options.nullDataLineDashType || !n[m - 1].lineDashType)) && (t[t.length - 1].newLineDashArray = A,
                                w = k.nullDataLineDashType) : (c(),
                                t = [])),
                                q = !0;
                            else {
                                ...
                                m < n.length - 1 && (x !== (n[m].lineColor || v) || w !== (n[m].lineDashType || k.lineDashType)) && (x = n[m].lineColor || v,
                                t[t.length - 1].newStrokeStyle = x,
                                b.setLineDash && (n[m].lineDashType ? (w = n[m].lineDashType,
                                t[t.length - 1].newLineDashArray = D(w, k.lineThickness)) : (w = k.lineDashType,
                                t[t.length - 1].newLineDashArray = H)));
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (; l < n.length; l++)
                        if (s = n[l].x.getTime ? n[l].x.getTime() : n[l].x,
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v))) {
                            var G = r;
                            "number" !== typeof n[l].y ? (k.connectNullData || (v || m) || c(),
                            v = !0) : (q = a.axisX.convertValueToPixel(s),
                            r = a.axisY.convertValueToPixel(n[l].y),
                            m || v ? (!m && k.connectNullData ? (b.setLineDash && (k._options.nullDataLineDashType || H === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (b.stroke(),
                            ...
                            u && d.lineTo(q, r),
                            0 == l % 250 && c()),
                            l < n.length - 1 && (A !== (n[l].lineColor || w) || H !== (n[l].lineDashType || k.lineDashType)) && (c(),
                            A = n[l].lineColor || w,
                            b.strokeStyle = A,
                            b.setLineDash && (n[l].lineDashType ? (H = n[l].lineDashType,
                            b.setLineDash(D(H, k.lineThickness))) : (H = k.lineDashType,
                            b.setLineDash(I)))),
                            G = k.dataPointIds[l],
                            this._eventManager.objectMap[G] = {
                                id: G,
    ...
    w.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            u && (r.beginPath(),
            r.rect(f.x1, f.y1, f.width, f.height),
            r.clip());
            for (var s = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                for (k = 0; k < z.length; k++)
                    y = z[k].x.getTime ? z[k].x.getTime() : z[k].x,
                    t.dataPointIndexes[y] = k,
                    s[y] || (p.push(y),
                    s[y] = !0);
                p.sort(Aa)
            }
                    ...
                    for (var K = !0, k = 0; k < p.length; k++) {
                        ...
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !K)))
                            if ("number" !== typeof I.y)
                                ...
                                g[l] = q - m;
                                s || K ? (!s && t.connectNullData ? (b.setLineDash && (t._options.nullDataLineDashType || w === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(),
                                w = t.nullDataLineDashType,
                                b.setLineDash(A)),
                                b.lineTo(n, m),
                                u && r.lineTo(n, m)) : (b.beginPath(),
                                b.moveTo(n, m),
                                u && (r.beginPath(),
                                r.moveTo(n, m))),
                                K = s = !1) : (b.lineTo(n, m),
                                ...
                                k < z.length - 1 && (x !== (z[k].lineColor || v) || w !== (z[k].lineDashType || t.lineDashType)) && (c(),
                                b.beginPath(),
                                b.moveTo(n, m),
                                h.push({
                                    x: n,
                                ...
                                x = z[k].lineColor || v,
                                b.strokeStyle = x,
                                b.setLineDash && (z[k].lineDashType ? (w = z[k].lineDashType,
                                b.setLineDash(D(w, t.lineThickness))) : (w = t.lineDashType,
                                b.setLineDash(H))));
                                ...
                                0 <= t.dataPointIndexes[l] && 0 !== I.markerSize && (0 < I.markerSize || 0 < t.markerSize) && (l = t.getMarkerProperties(k, n, m, b),
                                e.push(l),
                                markerColor = C(S),
                                u && e.push({
                                    x: n,
    ...
    w.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            u && (y.beginPath(),
            y.rect(e.x1, e.y1, e.width, e.height),
            y.clip());
            for (var t = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                for (k = 0; k < x.length; k++)
                    z = x[k].x.getTime ? x[k].x.getTime() : x[k].x,
                    v.dataPointIndexes[z] = k,
                    t[z] || (p.push(z),
                    t[z] = !0);
                p.sort(Aa)
            }
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < p.length) {
                    ...
                    for (var G = !0, k = 0; k < p.length; k++) {
                        ...
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!v.connectNullData || !G)))
                            if ("number" !== typeof S.y)
                                v.connectNullData || (G || t) || c(),
                                G = !0;
                            else {
                                ...
                                g[l] = q - m;
                                t || G ? (!t && v.connectNullData ? (b.setLineDash && (v._options.nullDataLineDashType || H === v.lineDashType && v.lineDashType !== v.nullDataLineDashType) && (b.stroke(),
                                H = v.nullDataLineDashType,
                                b.setLineDash(K)),
                                b.lineTo(n, m),
                                u && y.lineTo(n, m)) : (b.beginPath(),
                                b.moveTo(n, m),
                                u && (y.beginPath(),
                                y.moveTo(n, m))),
                                G = t = !1) : (b.lineTo(n, m),
                                ...
                                k < x.length - 1 && (A !== (x[k].lineColor || w) || H !== (x[k].lineDashType || v.lineDashType)) && (c(),
                                b.beginPath(),
                                b.moveTo(n, m),
                                h.push({
                                    x: n,
                                ...
                                A = x[k].lineColor || w,
                                b.strokeStyle = A,
                                b.setLineDash && (x[k].lineDashType ? (H = x[k].lineDashType,
                                b.setLineDash(D(H, v.lineThickness))) : (H = v.lineDashType,
                                b.setLineDash(I))));
                                ...
                                0 <= v.dataPointIndexes[l] && 0 !== S.markerSize && (0 < S.markerSize || 0 < v.markerSize) && (l = v.getMarkerProperties(k, n, m, b),
                                f.push(l),
                                markerColor = C(xa),
                                u && f.push({
                                    x: n,
    ...
    w.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= b)) {
            ...
            for (var p = -Infinity, k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++)
                for (var m = a.dataSeriesIndexes[n], l = this.data[m], q = l.dataPoints, r = 0, e = 0; e < q.length; e++)
                ...
                if (0 < m.length) {
                    ...
                    for (var l = 0, q = 0, e = 0; e < m.length; e++)
                        ...
                        !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                            ...
                            c.globalAlpha = 1;
                            Math.sqrt((l - f) * (l - f) + (q - g) * (q - g)) < Math.min(r.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (l = n.dataPointIds[e],
                            this._eventManager.objectMap[l] = {
                                id: l,
                                objectType: "dataPoint",
                                dataSeriesIndex: k,
                            ...
                            l = C(l),
                            u && P.drawMarker(r.x, r.y, this._eventManager.ghostCtx, r.type, r.size, l, l, r.borderThickness),
                ...
                if (0 < s.length)
                    for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        ...
                        !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                            ...
                            c.lineTo(f - x, p),
                            c.stroke(),
                            M(c, t, Math.min(g, k), z, Math.max(g, k), s[e].y[0] <= s[e].y[3] ? r.risingColor : d, v, d, y, y, !1, !1, r.fillOpacity),
                            u && (d = C(w),
                            b.strokeStyle = d,
                            b.moveTo(f - x, h),
                            ...
                            b.lineTo(f - x, p),
                            b.stroke(),
                            M(b, t, Math.min(g, k), z, Math.max(g, k), d, 0, null , !1, !1, !1, !1))) : "ohlc" === r.type && (c.moveTo(f - x, h),
                            c.lineTo(f - x, p),
                            c.stroke(),
                            c.beginPath(),
                            c.moveTo(f, g),
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < k.length) {
                    ...
                    for (var H = !0; m < k.length; m++)
                        ...
                        !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !H)))
                            if (null !== k[m].y && k[m].y.length && "number" === typeof k[m].y[0] && "number" === typeof k[m].y[1]) {
                                ...
                                n || H ? (p.connectNullData && !n ? (b.setLineDash && (p._options.nullDataLineDashType || x === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = A,
                                ...
                                m < k.length - 1 && (v !== (k[m].lineColor || z) || x !== (k[m].lineDashType || p.lineDashType)) && (c(),
                                v = k[m].lineColor || z,
                                g[g.length - 1].newStrokeStyle = v,
                                b.strokeStyle = v,
        ...
        function c(a, c) {
            ...
            if (0 < e.length) {
                ...
                for (f = 0; f < e.length - 3; f += 3)
                    b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y),
                    u && d.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y);
                e = ma(r, 2);
                    ...
                    for (m = !1; k < p.length; k++)
                        ...
                        !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !m)))
                            if (null !== p[k].y && p[k].y.length && "number" === typeof p[k].y[0] && "number" === typeof p[k].y[1]) {
                                ...
                                k < p.length - 1 && (t !== (p[k].lineColor || y) || z !== (p[k].lineDashType || h.lineDashType)) && (t = p[k].lineColor || y,
                                q[q.length - 1].newStrokeStyle = t,
                                b.setLineDash && (p[k].lineDashType ? (z = p[k].lineDashType,
                                q[q.length - 1].newLineDashArray = D(z, h.lineThickness)) : (z = h.lineDashType,
                                q[q.length - 1].newLineDashArray = v)));
                                ...
                                z = h.nullDataLineDashType) : (c(v, y),
                                q = [],
                                r = [])),
                                m = !0;
                    c(v, y);
        ...
        function c() {
            if (k && n) {
                ...
                for (e = 0; e < n.length; e++)
                    h = q[(c + e) % n.length],
                    1 < a && (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !m ? (h.hemisphere = "right",
                    f++) : (h.hemisphere = "left",
                    m = !0));
                m = !1;
                for (e = 0; e < n.length; e++)
                    h = q[(d + e) % n.length],
                    1 < b && (h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t) && (g <= b / 2 && !m ? (h.hemisphere = "left",
            ...
            for (b = 0; b < n.length; b++) {
                ...
                if (d > c) {
                    var e = 0.07 * A * Math.cos(q[b].midAngle)
                      ...
                      , g = !1;
                    if (n[b].exploded) {
                        if (1E-9 < Math.abs(q[b].center.x - (v.x + e)) || 1E-9 < Math.abs(q[b].center.y - (v.y + f)))
                            q[b].center.x = v.x + e * a,
                            q[b].center.y = v.y + f * a,
                            g = !0
                    } else if (0 < Math.abs(q[b].center.x - v.x) || 0 < Math.abs(q[b].center.y - v.y))
                        q[b].center.x = v.x + e * (1 - a),
                        q[b].center.y = v.y + f * (1 - a),
                        g = !0;
                    g && (e = {},
                    e.dataSeries = k,
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                ...
                for (l = 1; l < n.length; l++)
                    if (k = (a - l + q.length) % q.length,
                    q[k].hemisphere !== q[a].hemisphere) {
                        k = null ;
                        break
                    } else if (q[k].indexLabelText && q[k].hemisphere === q[a].hemisphere && k !== a && (0 > d(q[k], q[a]) || ("right" === q[a].hemisphere ? q[k].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[k].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))
                        break;
                    else
                        k = null ;
                p = k;
                m = e(a);
                l = k = 0;
                0 > b ? (l = "right" === h.hemisphere ? p : m,
                g = b,
                null !== l && (p = -b,
                b = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - (q[l].indexLabelTextBlock.y + q[l].indexLabelTextBlock.height / 2),
                b - p < r && (k = -p,
                l = f(l, k, c + 1),
                +l.toFixed(u) > +k.toFixed(u) && (g = b > r ? -(b - r) : -(p - (l - k)))))) : 0 < b && (l = "right" === h.hemisphere ? m : p,
                g = b,
                null !== l && (p = b,
                b = q[l].indexLabelTextBlock.y - q[l].indexLabelTextBlock.height / 2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2),
                b - p < r && (k = p,
                l = f(l, k, c + 1),
                +l.toFixed(u) < +k.toFixed(u) && (g = b > r ? b - r : p - (k - l)))));
                g && (c = h.indexLabelTextBlock.y + g,
                b = 0,
                b = "right" === h.hemisphere ? v.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - v.y, 2)) : v.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - v.y, 2)),
                h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t ? (k = (a - 1 + q.length) % q.length,
                k = q[k],
                a = q[(a + 1 + q.length) % q.length],
                "left" === h.hemisphere && "right" === k.hemisphere && b > k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x - 15 : "right" === h.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : h.midAngle > 3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t && (k = (a - 1 + q.length) % q.length,
                k = q[k],
                a = q[(a + 1 + q.length) % q.length],
                "right" === h.hemisphere && "left" === k.hemisphere && b < k.indexLabelTextBlock.x ? b = k.indexLabelTextBlock.x + 15 : "left" === h.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x - 15)),
                h.indexLabelTextBlock.y = c,
                h.indexLabelTextBlock.x = b,
                h.indexLabelAngle = Math.atan2(h.indexLabelTextBlock.y - v.y, h.indexLabelTextBlock.x - v.x))
            }
            return g
        }
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                ...
                if ("inside" !== k.indexLabelPlacement) {
                        ...
                        if (null !== w) {
                            ...
                            if (0 > B) {
                                for (var C = x = 0, D = 0; D < n.length; D++)
                                    D !== a && q[D].hemisphere === h.hemisphere && (q[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? x++ : C++);
                                x = B / (x + C || 1) * C;
                                var C = -1 * (B - x)
                                  , E = D = 0;
                                "right" === h.hemisphere ? (D = f(a, x),
                                C = -1 * (B - D),
                                E = f(w, C),
                                +E.toFixed(u) < +C.toFixed(u) && +D.toFixed(u) <= +x.toFixed(u) && f(a, -(C - E))) : (D = f(w, x),
                                C = -1 * (B - D),
                                E = f(a, C),
                                +E.toFixed(u) < +C.toFixed(u) && +D.toFixed(u) <= +x.toFixed(u) && f(w, -(C - E)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < n.length; a++)
                        ...
                        w = v.x + s * Math.cos(h.midAngle),
                        x = v.y + s * Math.sin(h.midAngle),
                        h.indexLabelTextBlock.x = w,
                        h.indexLabelTextBlock.y = x;
                for (a = 0; a < n.length; a++)
                    if (h = q[a],
                    w = h.indexLabelTextBlock.measureText(),
                    0 !== w.height && 0 !== w.width)
                        w = w = 0,
                        "right" === h.hemisphere ? (w = l.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + m),
                        w *= -1) : w = l.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - m),
                        0 < w && (!g && h.indexLabelText && (x = "right" === h.hemisphere ? l.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - l.x1,
                        0.3 * h.indexLabelTextBlock.maxWidth > x ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * x,
                        0.3 * h.indexLabelTextBlock.maxWidth < x && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)),
                        Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - v.y) < A || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - v.y) < A) && (w /= Math.abs(Math.cos(h.indexLabelAngle)),
                        9 < w && (w *= 0.3),
                        w > c && (c = w)),
                        w = w = 0,
                        0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (w = l.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5),
                        w *= -1) : w = l.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5),
                        0 < w && (!g && h.indexLabelText && (x = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1,
                        0 === f(a, w * x) && f(a, 2 * x)),
                        Math.abs(h.indexLabelTextBlock.x - v.x) < A && (w /= Math.abs(Math.sin(h.indexLabelAngle)),
                        9 < w && (w *= 0.3),
                        w > c && (c = w)));
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var l = m.legendMarkerType ? m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? Y.getDefaultLegendMarker(m.type) : m.markerType
                  ...
                  , t = m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : m.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0
                ...
                for (var u = 0; u < m.dataPoints.length; u++) {
                    var v = m.dataPoints[u]
                      ...
                      , q = v.legendText ? v.legendText : m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                        chart: this.chart._publicChartReference,
                        legend: this._options,
                        dataSeries: m,
                        dataPoint: v
        ...
        for (n = c = 0; n < k.length; n++) {
            ...
            for (v = u = 0; v < m.items.length; v++) {
                ...
                if ("line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType)
                    ...
                    this.ctx.beginPath(),
                    this.ctx.moveTo(r - 0.1 * this.lineHeight, y + this.lineHeight / 2),
                    this.ctx.lineTo(r + 0.85 * this.lineHeight, y + this.lineHeight / 2),
                    this.ctx.stroke(),
    ...
    Y.prototype.getDataPointAtX = function(a, c) {
        ...
        var b = {
          ...
          , k = 0
          , n = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (l) {
                    ...
                    case "doughnut":
                        ...
                        r < l.radius && r > u && (r = Math.atan2(c - s.y, a - s.x),
                        0 > r && (r += 2 * Math.PI),
                        r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        s = Number(((180 * (l.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        u = Number(((180 * (l.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        0 === u && 1 < l.endAngle && (u = 360),
                        s >= u && 0 !== q.y && (u += 360,
                        r < s && (r += 360)),
                        r > s && r < u && (d.push({
                            dataPoint: q,
    ...
    F.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, h),
            e = za(new Date(this.viewportMaximum), h, this.intervalType),
            ...
            if (this.labels) {
                ...
                d && (h = this.interval = a,
                this.intervalStartPosition = m)
            }
            for (b = this.intervalStartPosition; b <= e; b = parseFloat((b + 1 * h).toFixed(14)))
                a = this.labelFormatter ? this.labelFormatter({
                    chart: this.chart._publicChartReference,
                    axis: this._options,
                    value: b,
                    label: this.labels[b] ? this.labels[b] : null
                }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ba(b, this.valueFormatString, this.chart._cultureInfo),
                a = new O(this.ctx,{
                    x: 0,
                    y: 0,
                    maxWidth: f,
        ...
        if ("bottom" === this._position || "top" === this._position)
            p = this.lineCoordinates.width / Math.abs(this.viewportMaximum - this.viewportMinimum) * E[this.intervalType + "Duration"] * h,
            f = "undefined" === typeof this._options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth,
            ...
            p = this.lineCoordinates.height / Math.abs(this.viewportMaximum - this.viewportMinimum) * E[this.intervalType + "Duration"] * h,
            ...
            "bottom" === this._position || "top" === this._position) {
                ...
                if (!this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        ...
                        l = a.measureText(),
                        b < this._labels.length - 1 && (q = b + 1,
                        c = this._labels[q].textBlock,
                        c = c.measureText()),
                        e.push(a.height),
                        ...
                        x(this._options.labelAngle) && isNaN(this._options.labelAngle) && 0 !== this._options.labelAngle)
                            ...
                            !x(this._options.labelWrap))
                                ...
                                this.sessionVariables.labelWrap = this.labelWrap,
                                l.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                ...
                                this.sessionVariables.labelMaxHeight = g,
                                this.sessionVariables.labelMaxWidth = f,
                                l.width + c.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25,
                ...
                !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++)
                        ...
                        Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                        Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                        x(this._options.labelAngle) && isNaN(this._options.labelAngle) && 0 !== this._options.labelAngle) ? x(this._options.labelWrap) ? x(this._options.labelWrap) && (x(this._options.labelMaxWidth) ? x(c) || (p = l.height + c.height >> 0,
                        p - 2 * g > m && (m = p - 2 * g,
                        p >= 2 * g && p < 2.4 * g ? (x(this._options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                        a.measureText()),
                        this.sessionVariables.labelMaxHeight = g,
                        this.sessionVariables.labelFontSize = x(this._options.labelFontSize) ? this.labelFontSize : this._options.labelFontSize) : p >= 2.4 * g && p < 2.8 * g ? (this.sessionVariables.labelAngle = -25,
                        ...
                        this.sessionVariables.labelAngle = x(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : p >= 3.2 * g && p < 3.6 * g ? (this.sessionVariables.labelAngle = -25,
                        this.sessionVariables.labelMaxHeight = d,
                        this.sessionVariables.labelWrap = !0,
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === f.labelPlacement) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    u = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                if ("left" === this._position || "right" === this._position)
                    u = "undefined" === typeof f._options.labelWrap ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                ...
                u = "undefined" === typeof f._options.labelWrap || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
    ...
    F.setLayoutAndRender = function(a, c, b, d, e) {
        ...
        if ("normal" === d) {
            ...
            for (; 4 > l++; ) {
                ...
                !a.labelAutoFit || (x(v) || x(B)) || (0 < a.labelAngle ? B + r > g && (C += 0 < a.labelAngle ? B + r - g - s : 0) : 0 > a.labelAngle ? v - q < f && v - q < a.viewportMinimum && (A = f - (n + a.tickLength + u + v - q + a.labelFontSize / 2)) : 0 === a.labelAngle && (B + r > g && (C = B + r / 2 - g - s),
                v - q < f && v - q < a.viewportMinimum && (A = f - n - a.tickLength - u - v + q / 2)),
                a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 < a.labelAngle && 0 < C ? g -= C : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 > a.labelAngle && 0 < A ? f += A : a.viewportMaximum === a.maximum && a.viewportMinimum === a.minimum && 0 === a.labelAngle && (0 < A && (f += A),
                0 < C && (g -= C)));
                ...
                a._labels && 1 < a._labels.length && (v = (a._labels[1].position - a.viewportMinimum) * Math.abs(a.conversionParameters.pixelPerUnit) + a.lineCoordinates.x1,
                B = "dateTime" === a.chart.plotInfo.axisXValueType ? (a._labels[a._labels.length - 2].position - a.viewportMinimum) * Math.abs(a.conversionParameters.pixelPerUnit) + a.lineCoordinates.x1 : (a._labels[a._labels.length - 1].position - a.viewportMinimum) * Math.abs(a.conversionParameters.pixelPerUnit) + a.lineCoordinates.x1);
            ...
            for (; 4 > l++; ) {
                ...
                g = 0 < c.labelAngle ? g - u : 0 === c.labelAngle ? g - u / 2 : g),
                ...
                c && c.labelAutoFit && !x(t) && (f = 0 < b.labelAngle ? Math.max(f, t) : 0 === b.labelAngle ? Math.max(f, t / 2) : f,
                g -= w / 2),
                ...
                t = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                w = d.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(d.textBlock.angle)) + (d.textBlock.height - d.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(d.textBlock.angle)));
                ...
                f = 0 > c.labelAngle || 0 === c.labelAngle ? g - C : f);
        ...
        if ("undefined" === typeof this._options.interval) {
            if ("bottom" === this._position || "top" === this._position) {
                for (var e = 0; e < this._labels.length; e++)
                    f = this._labels[e],
                    f.position < this.viewportMinimum || (f = f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.height * Math.sin(Math.PI / 180 * this.labelAngle),
                    c += f);
            ...
            if ("left" === this._position || "right" === this._position) {
                for (e = 0; e < this._labels.length; e++)
                    f = this._labels[e],
                    f.position < this.viewportMinimum || (f = f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                    c += f);
                c > this.lineCoordinates.height * b && this.labelAutoFit && (a = !0)
            }
        }
        if ("bottom" === this._position) {
            for (var f, e = 0; e < this._ticks.length; e++)
                c = this._ticks[e],
                c.position < this.viewportMinimum || c.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(c.position),
                this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                this.ctx.strokeStyle = this.tickColor,
                b = 1 === this.ctx.lineWidth % 2 ? (c.x << 0) + 0.5 : c.x << 0,
                this.ctx.beginPath(),
                this.ctx.moveTo(b, c.y << 0),
                this.ctx.lineTo(b, c.y + this.tickLength << 0),
                this.ctx.stroke()));
            for (e = 0; e < this._labels.length; e++)
                f = this._labels[e],
                f.position < this.viewportMinimum || f.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(f.position),
                a && 0 !== d++ % 2 && this.labelAutoFit || (0 === f.textBlock.angle ? (c.x -= f.textBlock.width / 2,
                c.y += this.tickLength + f.textBlock.fontSize / 2) : (c.x -= 0 > this.labelAngle ? f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0,
                c.y += this.tickLength + Math.abs(0 > this.labelAngle ? f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                f.textBlock.x = c.x,
                f.textBlock.y = c.y,
            ...
            for (e = 0; e < this._ticks.length; e++)
                c = this._ticks[e],
                c.position < this.viewportMinimum || c.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(c.position),
                this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                this.ctx.strokeStyle = this.tickColor,
            ...
            for (e = 0; e < this._labels.length; e++)
                ...
                f.position < this.viewportMinimum || f.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(f.position),
                a && 0 !== d++ % 2 && this.labelAutoFit || (0 === f.textBlock.angle ? (c.x -= f.textBlock.width / 2,
                c.y -= this.tickLength + f.textBlock.height) : (c.x += (f.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                c.y -= this.tickLength + (f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))),
                f.textBlock.x = c.x,
                f.textBlock.y = c.y,
                f.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
            ...
            for (e = 0; e < this._ticks.length; e++)
                ...
                this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
                this.ctx.strokeStyle = this.tickColor,
                b = 1 === this.ctx.lineWidth % 2 ? (c.y << 0) + 0.5 : c.y << 0,
                this.ctx.beginPath(),
                this.ctx.moveTo(c.x << 0, b),
                this.ctx.lineTo(c.x - this.tickLength << 0, b),
                this.ctx.stroke()));
            for (e = 0; e < this._labels.length; e++)
                f = this._labels[e],
                f.position < this.viewportMinimum || f.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(f.position),
                a && 0 !== d++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (f.textBlock.y = c.y,
                f.textBlock.x = c.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5) : (f.textBlock.y = c.y - f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                f.textBlock.x = 0 < this.labelAngle ? c.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : c.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (f.textBlock.height - f.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength),
                f.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
            ...
            for (e = 0; e < this._labels.length; e++)
                ...
                f.position < this.viewportMinimum || f.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(f.position),
                a && 0 !== d++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (f.textBlock.y = c.y,
                f.textBlock.x = c.x + this.tickLength + 5) : (f.textBlock.y = 0 > this.labelAngle ? c.y : c.y - (f.textBlock.height - f.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                f.textBlock.x = 0 < this.labelAngle ? c.x + (f.textBlock.height - f.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : c.x + this.tickLength + 5),
                f.textBlock.render(!0)));
            this.title && (this._titleTextBlock.measureText(),
    ...
    F.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            ...
            e = 0; e < this._ticks.length; e++)
                c ? (c = this.getPixelCoordinatesOnAxis(this._ticks[e].position),
                b = e + 1 > this._ticks.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._ticks[e + 1].position),
            ...
            e = 0; e < this._ticks.length; e++)
                ...
                c = e + 1 > this._ticks.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._ticks[e + 1].position),
    ...
    F.prototype.convertValueToPixel = function(a) {
        return this.conversionParameters.reference + this.conversionParameters.pixelPerUnit * (a - this.conversionParameters.minimum) + 0.5 << 0
    }
    ;
    F.prototype.calculateAxisParameters = function() {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
            ...
            this.intervalType = "month") : (this.interval = b / (1 * E.yearDuration) <= a ? 1 : b / (2 * E.yearDuration) <= a ? 2 : b / (4 * E.yearDuration) <= a ? 4 : Math.floor(F.getNiceNumber(b / (a - 1), !0) / E.yearDuration),
            ...
            this.interval = this._options && 0 < this._options.interval ? this._options.interval : F.getNiceNumber(b / (a - 1), !0);
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            ...
            this._options && "undefined" === typeof this._options.interval && (this.interval = F.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)))
        }
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                ...
                if (g = this.chart.getDataPointAtXY(a, c, !0))
                    ...
                    if (g = Ea(a, c, this.chart._eventManager.ghostCtx),
    ...
    V.prototype.highlightObjects = function(a) {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                f.borderColor = f.borderColor || "#FFFFFF",
                f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                P.drawMarkers([f]))) : "bubble" === d.type ? (f = d.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                f.size = e.size,
                f.color = "white",
                f.borderColor = "white",
                c.globalAlpha = 0.3,
    ...
    ;
    w.prototype.replaceKeywordsWithValue = function(a, c, b, d, e) {
        var f = this;
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do {
                ...
                a = a.replace("#percent", ba(g, p, f._cultureInfo));
